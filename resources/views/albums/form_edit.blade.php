            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-sm-10">
                    <div class="contact-form">
                        <form action="{{url(route('edit_album' , [$album->id]))}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group ">
                                <label for="inputName">Write Album Name</label>
                                <input type="text" id="inputName" class="form-control"
                                       placeholder="Write Your Name" name="name" value="{{old('name' , $album->name)}}">
                                @if($errors)
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control" id="type">
                                    <option value="{{old('type' ,$album->type)}}"> {{$album->type}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="cover" class="form-control" placeholder="Pick Album Cover" name="cover" value="{{old('cover' , $album->cover)}}">
                                @if($errors)
